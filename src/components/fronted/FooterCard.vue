      ...
      <div class="py-lg-55 pt-4 pb-5">
              ...
              <ul class="list-unstyled mt-lg-5 mt-4 d-lg-block d-flex">
                <li class="py-lg-25 py-0 me-2 me-lg-0">
                  ...
                  >
                    ...
                    <img
                      src="https://storage.googleapis.com/vue-course-api.appspot.com/peihanwang-hexschool/1699881622029.png"
                ...
                <li class="py-lg-25 py-0 ms-2 ms-lg-0">
                  <a
                    ...
                    <img
                      src="https://storage.googleapis.com/vue-course-api.appspot.com/peihanwang-hexschool/1699881606866.png"
                      class="d-lg-none d-block img-fluid"
                      alt="透明底白字的白娜手作 Logo"
                      width="70"
                      height="70"
        ...
        >
          ...
          <li class="order-3 order-lg-2 text-center">
            Copyright © 2023 Nocab. All rights reserved.
          </li>
